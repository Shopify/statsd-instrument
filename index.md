...
- [The changelog](https://github.com/Shopify/statsd-instrument/blob/master/CHANGELOG.md) covers the changes between releases.
- [Contributing notes](https://github.com/Shopify/statsd-instrument/blob/master/CONTRIBUTING.md) if you are interested in contributing to this library.
