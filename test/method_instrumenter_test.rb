...
class MethodInstrumenterTest < Minitest::Test
  ...
  class ToBeInstrumented
    ...
    def inspect
      '#<MethodInstrumenterTest::ToBeInstrumented:instance>'
    end
  ...
  ToBeInstrumented.prepend StatsD.count_method(:i_am_protected, name: "i_am_protected")
  ToBeInstrumented.prepend StatsD.count_method(:i_am_private, name: "i_am_private")
  ToBeInstrumented.prepend StatsD.count_method(:to_raise, name: "to_raise")
  ToBeInstrumented.prepend StatsD.count_method(:to_raise_with_suffix, name: "to_raise_with_suffix", on_exception: SuffixedExcpetionHandler)
  ToBeInstrumented.prepend StatsD.count_method(:to_be_counted_with_suffix, name: "to_be_counted_with_suffix", on_success: SuffixedHandler)
  ToBeInstrumented.prepend StatsD.count_method(:to_be_counted, name: "to_be_counted")
  ToBeInstrumented.singleton_class.prepend StatsD.count_method(:i_am_protected, name: "i_am_protected_too")
  ToBeInstrumented.singleton_class.prepend StatsD.count_method(:i_am_private, name: "i_am_private_too")
  ToBeInstrumented.singleton_class.prepend StatsD.count_method(:to_raise_too, name: "to_raise_too")
  ToBeInstrumented.singleton_class.prepend StatsD.count_method(:to_raise_too_with_suffix, name: "to_raise_too_with_suffix", on_exception: SuffixedExcpetionHandler)
  ToBeInstrumented.singleton_class.prepend StatsD.count_method(:to_be_counted_too_with_suffix, name: "to_be_counted_too_with_suffix", on_success: SuffixedHandler)
  ToBeInstrumented.singleton_class.prepend StatsD.count_method(:to_be_counted_too, name: "to_be_counted_too")
  ...
  def test_instance_method_ancestors
    ...
    assert_instance_of StatsD::Instrument::MethodInstrumenter, counter_module
    assert_equal :to_be_counted, counter_module.method_name
    assert_equal '#<StatsD::Instrument::MethodInstrumenter[:to_be_counted]>', counter_module.inspect
  end
  ...
  def test_singleton_class_method_ancestors
    ...
    assert_equal '#<StatsD::Instrument::MethodInstrumenter[:to_be_counted_too]>', counter_module.inspect
  end
  ...
  def test_no_littering_in_instrumented_class
    ...
    assert_equal '#<MethodInstrumenterTest::ToBeInstrumented:instance>', ToBeInstrumented.new.inspect
    assert_equal 'MethodInstrumenterTest::ToBeInstrumented', ToBeInstrumented.inspect
  end
